package dennis_fx;/*import javax.print.attribute.standard.MediaSize;
...
public class category_m <E> {
    ...
    public static morphism compose(morphism f1, morphism f2) throws IllegalCompositionError{
